...
public:
    ...
    size_t getNextVirtualRegister(Type* type, uint32_t c) { m_vRegTypes.push_back({type, c}); return m_currentVirtualRegister++; }
    VRegInfo& getVirtualRegisterInfo(size_t id) { return m_vRegTypes[id - VREG_START]; }
